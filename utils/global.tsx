      ...
      return (
        <div>
          ...
          <ol className="ml-4 list-decimal">
            ...
            <li>
              <span>
                โปรโมชั่น <strong>ซื้อครบ 1 ชิ้น ลด 10.-</strong>
              </span>
              <ul className="ml-4 list-disc">
                <li>รหัสส่วนลด: MLP10</li>
                <li>วันสิ้นสุด: 31 สิงหาคม 2567</li>
                <li>
                  รายละเอียด: เมื่อซื้อสินค้าโมลเพ็ด ที่ร่วมรายการครบ 1 ชิ้น รับส่วนลดมูลค่า 10 บาท
                </li>
              </ul>
            </li>
            <li>
              <span>
                โปรโมชั่น <strong>ซื้อครบ 500.- ลด 50.-</strong>
              </span>
              <ul className="ml-4 list-disc">
                <li>รหัสส่วนลด: RICE50</li>
                <li>วันสิ้นสุด: 2 ตุลาคม 2567</li>
                <li>รายละเอียด: เมื่อซื้อสินค้าที่ร่วมรายการครบ 500 บาท รับส่วนลดมูลค่า 50 บาท</li>
              </ul>
            </li>
          </ol>
          <span>
